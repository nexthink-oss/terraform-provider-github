...
func (d *githubOrganizationTeamsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var query githubpkg.TeamsQuery
...
func (d *githubOrganizationTeamsDataSource) convertTeamsQueryToModels(ctx context.Context, query githubpkg.TeamsQuery, summaryOnly bool) []githubOrganizationTeamModel {
